...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Both are inlined (Deno cannot import local files). Same logic as clothingAwarenessContext.js.
    const selfClothingBlock = buildSelfClothingAwarenessInline(character);
