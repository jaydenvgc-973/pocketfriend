// ═══════════════════════════════════════════════════════════════════════════
// SOLE CANONICAL WRITER — One Truth Authority (rabbit-hole v2)
// ═══════════════════════════════════════════════════════════════════════════
//
...
function evaluateRequestedTransition(character, locationMap, requested, etTime) {
  ...
  if (requestedStatus === 'at_work') {
    ...
    if (!requestedLocId && requested.requested_location_name) {
      console.log(`[enforceCharacterLocationPresence] RABBIT_HOLE_BRANCH entered: location_name=${requested.requested_location_name}, authority=${requested.requested_authority}`);
