...
function buildPrompt({ prompt, charName, charDesc, charRecord, locationName, zoneName, locCategory, envRefCount, charRefCount, userRefCount, userRefStart, charRefStart, envRefStart, serverHour, serverTime, subjectType, characterId, userWorldName, userOutfitText, userAppearanceLockText, existingObjectCue, userGender }) {
