...
function computeAdaptiveSleepWindow(character, etTime) {
  ...
  // Only TODAY's work day drives sleep timing. Tomorrow's schedule is not authority.
 ...
 *
 * NOT called here (scheduled enforcement file). Kept for documentation and future scoring-context reconnection.
 */
