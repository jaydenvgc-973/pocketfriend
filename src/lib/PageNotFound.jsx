                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-foreground bg-card border border-border rounded-xl hover:bg-secondary transition-colors"
                        >
                            Go Home
                        </button>
                    </div>
