...
const DINER_ACTIONS = [
  ...
  { id: "jukebox", label: "Play jukebox", emoji: "🎵", cost: 2, type: "functional", payer: "user" },
...
const BAR_CLUB_ACTIONS = [
  ...
  { id: "char_buy_round", label: "Let them buy", emoji: "🎁", cost: 25, type: "social", payer: "character" },
...
const RESTAURANT_ACTIONS = [
  ...
  { id: "chat_server", label: "Chat with server", emoji: "🗣️", cost: 0, type: "social", requires_staff: true },
  { id: "check", label: "Pick up the check", emoji: "🧾", cost: 40, type: "functional", payer: "user" },
  { id: "char_pays", label: "Let them cover it", emoji: "💳", cost: 30, type: "functional", payer: "character" },
...
const HOME_ACTIONS = [
  ...
  { id: "eat", label: "Eat something", emoji: "🍽️", cost: 0, type: "functional", action_category: "food", suggested_zone: "Kitchen" },
  { id: "drink", label: "Get a drink", emoji: "🥤", cost: 0, type: "functional", action_category: "drink", suggested_zone: "Kitchen" },
  ...
  { id: "order_takeout", label: "Order takeout", emoji: "🥡", cost: 20, type: "functional", payer: "user", action_category: "food" },
...
const SHELTER_ACTIONS = [
  ...
  { id: "shelter_eat", label: "Get a meal", emoji: "🍽️", cost: 0, type: "functional", action_category: "food", suggested_zone: "Dining Area" },
...
const SALON_ACTIONS = [
  ...
  { id: "salon_cut", label: "Get a cut", emoji: "✂️", cost: 45, type: "functional", payer: "user", suggested_zone: "Styling Area", requires_staff: true },
  { id: "salon_color", label: "Color treatment", emoji: "🎨", cost: 80, type: "functional", payer: "user", suggested_zone: "Styling Area", requires_staff: true },
  { id: "salon_nails", label: "Get nails done", emoji: "💅", cost: 40, type: "functional", payer: "user", requires_staff: true },
...
const CLOTHING_STORE_ACTIONS = [
  ...
  { id: "buy", label: "Buy something", emoji: "💳", cost: 35, type: "functional", payer: "user", action_category: "clothing", suggested_zone: "Register", requires_staff: true },
  { id: "clothing_buy", label: "Buy item", emoji: "🛒", cost: 35, type: "functional", payer: "user", action_category: "clothing", suggested_zone: "Register", requires_staff: true },
...
const RETAIL_STORE_ACTIONS = [
  ...
  { id: "retail_checkout", label: "Check out", emoji: "💳", cost: 35, type: "functional", payer: "user", action_category: "clothing", suggested_zone: "Checkout", requires_staff: true },
  { id: "buy", label: "Buy something", emoji: "🛒", cost: 35, type: "functional", payer: "user" },
