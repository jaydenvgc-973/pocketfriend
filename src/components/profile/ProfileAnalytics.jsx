  ...
  return (
    <>
      ...
      <section className="bg-card border border-border rounded-2xl p-5">
        ...
        {/* Revenue vs Expenses graph — full width underneath */}
        <div className="bg-secondary/30 border border-border/50 rounded-xl p-3">
          <p className="text-xs font-semibold text-foreground uppercase tracking-wider mb-1">Revenue vs Expenses</p>
          <p className="text-[10px] text-muted-foreground mb-2">Last {months} months</p>
