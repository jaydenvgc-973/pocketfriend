  ...
  return (
    <div className="rounded-xl overflow-hidden border border-white/10 max-w-xs shadow-lg bg-card/80">
      ...
      {hasCoverArt ? (
        ...
        <div className={`${headerColor} p-4 flex items-center gap-3`}>
          <div className="w-12 h-12 rounded-lg bg-white/20 flex items-center justify-center flex-shrink-0 shrink-0">
