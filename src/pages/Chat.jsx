...
import { buildEducationContext, buildSongsContext, buildDynamicContexts, buildImageRule, validateLocationInResponse, buildLinkContext, buildFinancialContext } from "@/lib/promptContextBuilders";
...
export default function Chat() {
  ...
  const sendMessage = async (text, userImageUrl) => {
    ...
    try {
      ...
      const [{ weatherContext, recentEventsContext, culturalContext }, financialContext] = await Promise.all([
