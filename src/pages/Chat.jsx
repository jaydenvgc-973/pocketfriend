...
import { buildEducationContext, buildSongsContext, buildDynamicContexts, buildImageRule, validateLocationInResponse, buildWeatherMoodContext } from "@/lib/promptContextBuilders";
...
export default function Chat() {
  ...
  const sendMessage = async (text, userImageUrl) => {
    ...
    try {
      ...
      // Persistent weather mood modifier — always injected when weather is notable (severe/mild/nice)
      // Source of truth: UserSettings.daily_weather_cache (populated by fetchDailyWeather automation)
      const weatherMoodContext = buildWeatherMoodContext(userSettings?.daily_weather_cache || null, character);
