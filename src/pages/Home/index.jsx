...
export default function Home() {
  ...
  const activeCustomChars = customChars.filter(c => (c.status === "active" || !c.status) && !["npc", "npc_fictitious_person", "family_npc"].includes(c.character_type) && c.name !== "Leo Parker");
