...
const TESTS = [
  ...
  },
  {
    ...
    participants: ["A", "C"],
    imageUrl: "https://media.base44.com/images/public/69bfd8da2f47364437a2deaa/d999485e5_generated_image.png",
    messageId: "6a3c546b9504c2d117bd75cc",
    type: "regen",
    reason: "no_avatar",
    intendedSubjectIds: ["A_id", "C_id"],
    status: "✅ PASS",
    notes: "subject_source=user_picker_selection. B removed, C added. Rebuilt bundles using picker selection.",
  },
  {
    id: "T6",
    label: "Test 6 — Regen original A+B → select A+B+D+E",
    participants: ["A", "B", "D", "E"],
    imageUrl: "https://media.base44.com/images/public/69bfd8da2f47364437a2deaa/1c74de2a4_generated_image.png",
    messageId: "6a3c546b9504c2d117bd75cc",
    type: "regen",
    reason: "no_avatar",
    intendedSubjectIds: ["A_id", "B_id", "D_id", "E_id"],
    status: "✅ PASS",
    notes: "4-character picker selection accepted. All IDs passed to regeneration payload.",
  },
];
